...
LUA_SHA1 = get_hash(os.path.join(CWD, 'eroshare.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            "--warc-header", "eroshare-dld-script-version: " + VERSION,
            "--warc-header", ItemInterpolation("eroshare-item: %(item_name)s"),
        ]
...
project = Project(
    title = "eroshare",
    project_html = """
    <img class="project-logo" alt="logo" src="https://assets.eroshare.com/assets/logo-eroshare-vertical-aaecade15bb82086a55170921a5b09bf.png" />
    <h2>eroshare.com <span class="links"><a href="http://eroshare.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/eroshare/">Leaderboard</a></span></h2>
    """,
    utc_deadline = datetime.datetime(2017, 6, 30, 23, 59, 0)
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="eroshare"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
